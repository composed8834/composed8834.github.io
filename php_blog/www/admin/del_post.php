...
<p class="choose_del">Выберите заметку для удаления</p>
	<form action="drop_post.php" method="post" class="form">
<?
...
<p><input type="submit" value="Удалить заметку" class="submit" /></p>
</form>
